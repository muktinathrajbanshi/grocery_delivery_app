                        ...
                        <div className="relative">
                            ...
                            : (
                                <div className="flex-center gap-2">
                                    ...
                                    px-4 py-2 text-sm font-medium text-white bg-green-950
                            ...
                            {userMenuOpen && (
                                ...
                                border border-app-border py-2 z-50 animate-fade-in">
                                    ...
                                    className="dropdown-link"><ShieldIcon className="text-app-orange-dark" 
                                    size={16} /><span className="text-app-orange-dark">Admin Panel</span></Link>
                                    )}
                                    {user && (
