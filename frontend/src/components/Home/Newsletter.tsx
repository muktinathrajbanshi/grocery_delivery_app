...
const Newsletter = () => {
  return (
    ...
    <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-app-text-light mb-8 text-base">Get weekly updates on fresh produce, seasonal offers, and exclusive discounts
            ...
            className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                ...
                hover:bg-app-green-light transition-colors shadow-sm whitespace-nowrap
                active:scale-[0.98]">Subscribe</button>
            </form>
    </div>
    </section>
  )
